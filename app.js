...
btn.onclick = function () {
  ...
  var tNo = 1000;
  document.getElementById('ferryName').innerHTML = document.getElementById('foption').value;
  document.getElementById('VferryName').innerHTML = document.getElementById('foption').value;
  ...
  document.getElementById("tPqunt").innerHTML =
